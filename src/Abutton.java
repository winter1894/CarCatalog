 ...
 * 
 * @author Matthew
 * A class dedicated to the functions and design of a button.
 */
public class Abutton
{
	...
	/**
	 * To hold the label of the button
	 */
	private String theLabel;
	/**
	 * Information on the color of the button
	 */	
	private Color theColor;	
	/**
	 * The location of the button and sizes of the button.
	 */
	private int x, y,
	width, height;	
	/**
	 * To make it appear a button has been pressed.
	 */
	private boolean up;	
